...
export const infoCardText = [
    ...
    {
        "id":2,
        "title":"¿Guivana 3 está disponible?",
        "description":"Guivana 3 es una versión alternativa, todas las películas de estrenos, series, documentales premiados entre otros títulos destacados agrupados en un mismo portal."
    },
    {
        "id":3,
